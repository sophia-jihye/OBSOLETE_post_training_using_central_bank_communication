...
class FeatureExtractor:
    ...
    def get_cls_embedding(self, text):
        ...
        return np.squeeze(cls_feature).mean(0).detach().cpu().numpy() # Caltulate the average

# Obtain the BERT embedding values
class FeatureExtractor_pipeline:
    ...
    def get_feature(self, text):
        ...
        return feature.mean(0) # Caltulate the average